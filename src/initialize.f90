...
subroutine outputCopyright(io,ierr)
   ...
   write(io,'(A107)') "| **                                                                                                     **"
   write(io,'(A107)') "| **                                                                                                     **"
   write(io,'(A107)') "| **                                         Copyright (c) 2025                                          **"
   ...
   write(io,'(A107)') "| Brothers, E.; Palos, E.; Tripathy, V.; Goetz, A.W.; Merz, K.M. QUICK-25.03.                              "
   write(io,'(A107)') "| University of California,San Diego, CA and                                                               "
   write(io,'(A107)') "| Michigan State University, East Lansing, MI, 2025                                                        "
   write(io,'(A107)') "|                                                                                                          "
